...
class Afiliacion:
    def Editar(self, driver, NContrato):
        ...
        Evento.DobleClickByXpath(driver, '/html/body/app-root/app-content-layout/div/app-afiliacion-empresarial-index/p-panel/div/div[2]/div/div[2]/app-afiliacion-empresarial-list/p-panel/div/div[2]/div/div/div/p-table/div/div/table/tbody/tr[1]/td[8]/div/button[3]/span/i')
